export class Utils {
    ...
    static applyCustomeTheme(primaryColor: string, secondary?: string) {
        ...
        Utils.applyThemeForClass("logo", 'border', `2px solid ${secondary}`)
        Utils.applyThemeForClass("details", 'color', secondary)
        Utils.applyThemeForClass("product", 'color', secondary)
        Utils.applyThemeForClass("price", 'color', secondary)
        Utils.applyThemeForClass("bg-light", 'color', primaryColor)
        Utils.applyThemeForClass("footer-header", 'color', secondary)
        Utils.applyThemeForClass("page-header", 'color', secondary)
